...
- Custo médio de um ponto só existe com quantidade **e** valor positivos: ponto com quantidade positiva e valor zero ou negativo (sobra de um negativo sem ajuste de custo) daria saída com valor negativo. `consumptionPartValue` trata esse ponto como sem média, e a saída inteira vira provisória pela referência.
