...
| DEC-127 | Sobra entra pelo valor informado, que a revisão preenche com a média do ponto quando ele tem custo médio (quantidade positiva e valor não negativo, pela DEC-181) ou com o custo de referência; falta sai pela média do ponto na finalização; um motivo e uma data para a contagem inteira, com até 500 linhas (2026-09-23) | Média com ponto vazio a zero; média ou custo de referência calculados no servidor; motivo por linha | Dupla | RF-EST-13, RF-EST-14 |
