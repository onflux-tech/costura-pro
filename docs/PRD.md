...
- **RF-ATD-07** Na recepção de **peça recebida**, descrição, estado e quantidade são obrigatórios; fotos, acessórios e observações são opcionais. Datas de recepção e devolução e o responsável são registrados.
...
- **RF-ACE-14** Fotos são otimizadas no aparelho ao capturar, com miniaturas. O dono pode baixar o arquivo otimizado preservado. Todas as miniaturas ficam disponíveis offline; imagens grandes já vistas ficam em cache.
