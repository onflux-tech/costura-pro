...
- Revisão comercial com nova aprovação lançando só a diferença, cancelamento e liquidação, consumo com lote e reconciliação (que libera o "Pronto" da peça com material), entrega parcial e comprovante, recebíveis com parcelas e pagamentos, encerramento da OS, lista de compras consolidada, documentos, agenda com o calendário de prazos e custódia.
