...
**Estado:** cliente, perfil, modelo de medidas, medição, peça recebida, material, variante, local, lote, movimento de estoque, fornecedor, compra, obrigação, conta, movimento financeiro, serviço, produto e variante de produto implementados; o resto previsto (F3 a F5).
