...
| Serviço, produto e ficha técnica | Previsto | | F3, F4 |
...
**Estado:** cliente, perfil, modelo de medidas, medição, peça recebida, material, variante, local, lote, movimento de estoque, fornecedor, compra, obrigação, conta e movimento financeiro implementados; o resto previsto (F3 a F5).
...
type Operation = {
  ...
  aggregateType: string; // "installation" | "device" | "client" | "profile" | "measurementTemplate" | "measurement" | "receivedItem" | "material" | "materialVariant" | "stockLocation" | "stockLot" | "stockMovement" | "supplier" | "purchase" | "purchaseReversal" | "obligation" | "financialAccount" | "financialMovement"
  aggregateId: string;
