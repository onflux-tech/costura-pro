...
|---|---|---|---|
| Monorepo e PWA básica gerados pelo scaffold; app Tauri legado, com remoção pendente (DEC-59) | Implementado | `apps/web`, `apps/web/src-tauri`, `apps/server`, `packages/*` | F0 |
...
| `apps/web/src-tauri` | Legado do scaffold (Tauri v2), sem papel no produto desde a DEC-59; remoção pendente na F0 |
